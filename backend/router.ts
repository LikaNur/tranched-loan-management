...
export const appRouter = router({
    ...
    getInactiveLoans: publicProcedure.query(async () => Array.from(inactiveMap.values())),
    getActiveLoans: publicProcedure.query(async () => Array.from(activeMap.values())),
    moveLoanToActive: publicProcedure
        .input(z.number())
        .mutation(async (opts) => {
            await randomWait()
